...
namespace ANT.ScriptableProperties
{
    ...
    public class ScriptableFloatRange : ScriptableFloat, IRange<float>
    {
        ...
        /// </summary>
        public void SetMin(ScriptableFloat value)
        {
            if (!value) return;
        ...
        /// </summary>
        public void SetMax(ScriptableFloat value)
        {
            if (!value) return;
